...
public class AmbulanceAdminHomeActivity extends AppCompatActivity {
    TextView tv_1,tv_2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ambulance_admin_home);

        reference = FirebaseDatabase.getInstance().getReference("Ambulance Services");
