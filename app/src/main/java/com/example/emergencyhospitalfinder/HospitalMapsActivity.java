...
public class HospitalMapsActivity extends FragmentActivity implements
        OnMapReadyCallback,
    ...
    private String getUrl( double latitude, double longitude, String nearbyPlace)
    {
        ...
        googleURL.append("&key=" + "AIzaSyBTMDhjzN7ZcvIlhGfYtcRblu7o7n71dHM");
        Log.d("HospitalMapsActivity","url = " + googleURL.toString());
