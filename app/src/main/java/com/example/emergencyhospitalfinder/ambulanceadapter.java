...
public class ambulanceadapter extends FirebaseRecyclerAdapter<amulancemodel,ambulanceadapter.ambulanceviewholder> {
    public ambulanceadapter(@NonNull FirebaseRecyclerOptions<amulancemodel> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull final ambulanceviewholder holder, final int position, @NonNull final amulancemodel model) {
        ...
        holder.edittext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final DialogPlus dialogPlus=DialogPlus.newDialog(holder.edittext.getContext())
                        .setContentHolder(new ViewHolder(R.layout.ambulancedialogcontent))
                ...
                hsubmit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("Ambulance Services")
    ...
    public ambulanceviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
       View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.amulancesinglerow,parent,false);
