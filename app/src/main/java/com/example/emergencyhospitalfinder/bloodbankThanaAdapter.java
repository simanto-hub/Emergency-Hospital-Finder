...
public class bloodbankThanaAdapter extends FirebaseRecyclerAdapter<amulancemodel,bloodbankThanaAdapter.thanaviewholder> {
    public bloodbankThanaAdapter(@NonNull FirebaseRecyclerOptions<amulancemodel> options) {
        super(options);
    }
    ...
    public thanaviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.bloodbankthanasinglerow,parent,false);
